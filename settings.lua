...
logistical_logistics_radius = startup:default("logistical-roboport-logistics-radius", 50, { minimum = 0, maximum = 500 })
logistical_construction_radius = startup:default("logistical-roboport-construction-radius", 50, { minimum = 0, maximum = 500 })
...
logistical_logistics_radius_modifier = startup:default("logistical-roboport-logistics-radius-modifier", 5, { minimum = -100, maximum = 100 })
logistical_construction_radius_modifier = startup:default("logistical-roboport-construction-radius-modifier", 10, { minimum = -100, maximum = 100 })
logistical_robot_modifier = startup:default("logistical-roboport-robot-modifier", 1, { minimum = 0, maximum = 100 })
logistical_material_modifier = startup:default("logistical-roboport-material-modifier", 1, { minimum = 0, maximum = 100 })
